...
namespace AerolineaFrba.Consulta_Millas
{
    public partial class ConsultarMillas : Form
    {
        ...
        private void millasHistoricas() 
        {
            ...
            string sql1 = "SELECT MILLAS_PASA_ID ID_DE_PASAJE, MILLAS_ENCO_ID ID_DE_ENCOMIENDA, MILLAS_CANTIDAD_HISTORICA CANTIDAD_DE_MILLAS_HISTORICAS, MILLAS_FECHA FECHA FROM DJML.MILLAS WHERE MILLAS_CLIE_ID = '" + IDC + "' AND MILLAS_FECHA < GETDATE()";
