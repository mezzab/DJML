...
--=======================================================================
	...
	COMPRA_VIAJE_ID INT FOREIGN KEY REFERENCES DJML.VIAJES(VIAJ_ID) NOT NULL,
...
CREATE TABLE DJML.CANJES (
	...
	CANJ_CLIE_TIPO_DOC INT NOT NULL, 
    CANJ_CLI_DNI        INT             NOT NULL,
	...
	CONSTRAINT FK_CANJES_CLIENTES FOREIGN KEY (CANJ_CLIE_DNI, CANJ_CLIE_TIPO_DOC) REFERENCES DJML.CLIENTES (CLIE_DNI, CLIE_TIPO_DOC) 
)
---------------------------------------------------- NO SE MIGRA
