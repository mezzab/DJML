...
DROP PROCEDURE DJML.REGISTRO_DESTINO
...
--=======================================================================
	...
	COMPRA_ID_USUARIO INT FOREIGN KEY REFERENCES DJML.USUARIOS(USUA_USERNAME) NOT NULL,
	COMPRA_MEDIO_DE_PAGO NVARCHAR(255),
