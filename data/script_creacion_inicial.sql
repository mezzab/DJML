...
--============================================================
	...
	CREATE TABLE DJML.ROL_FUNCIONALIDAD(
		...
		INSERT INTO DJML.ROL_FUNCIONALIDAD VALUES (1, (SELECT FUNC_ID FROM DJML.FUNCIONALIDAD WHERE DESCRIPCION = 'ABM ROL'), 1)
		INSERT INTO DJML.ROL_FUNCIONALIDAD VALUES (1, (SELECT FUNC_ID FROM DJML.FUNCIONALIDAD WHERE DESCRIPCION = 'ABM CIUDAD'), 1)
		INSERT INTO DJML.ROL_FUNCIONALIDAD VALUES (1, (SELECT FUNC_ID FROM DJML.FUNCIONALIDAD WHERE DESCRIPCION = 'ABM RUTA AEREA'), 1)
		INSERT INTO DJML.ROL_FUNCIONALIDAD VALUES (1, (SELECT FUNC_ID FROM DJML.FUNCIONALIDAD WHERE DESCRIPCION = 'ABM AERONAVE'), 1)
		INSERT INTO DJML.ROL_FUNCIONALIDAD VALUES (1, (SELECT FUNC_ID FROM DJML.FUNCIONALIDAD WHERE DESCRIPCION = 'GENERAR VIAJE'), 1)
		INSERT INTO DJML.ROL_FUNCIONALIDAD VALUES (1, (SELECT FUNC_ID FROM DJML.FUNCIONALIDAD WHERE DESCRIPCION = 'REGISTRO DE LLEGADA A DESTINO'), 1)
		INSERT INTO DJML.ROL_FUNCIONALIDAD VALUES (1, (SELECT FUNC_ID FROM DJML.FUNCIONALIDAD WHERE DESCRIPCION = 'COMPRA PASAJE/ENCOMIENDA'), 1)
		INSERT INTO DJML.ROL_FUNCIONALIDAD VALUES (1, (SELECT FUNC_ID FROM DJML.FUNCIONALIDAD WHERE DESCRIPCION = 'DEVOLUCION/CANCELACION PASAJE/ENCOMIENDA'), 1)
		INSERT INTO DJML.ROL_FUNCIONALIDAD VALUES (1, (SELECT FUNC_ID FROM DJML.FUNCIONALIDAD WHERE DESCRIPCION = 'LISTADO ESTADISTICO'), 1)
		---FUNCIONALIDADES DEL CLIENTE
		INSERT INTO DJML.ROL_FUNCIONALIDAD VALUES (2, (SELECT FUNC_ID FROM DJML.FUNCIONALIDAD WHERE DESCRIPCION = 'COMPRA PASAJE/ENCOMIENDA'), 1)
		INSERT INTO DJML.ROL_FUNCIONALIDAD VALUES (2, (SELECT FUNC_ID FROM DJML.FUNCIONALIDAD WHERE DESCRIPCION = 'CONSULTA MILLAS PASAJERO'), 1)
		INSERT INTO DJML.ROL_FUNCIONALIDAD VALUES (2, (SELECT FUNC_ID FROM DJML.FUNCIONALIDAD WHERE DESCRIPCION = 'CANJE MILLAS'), 1)
