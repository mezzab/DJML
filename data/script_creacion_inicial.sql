...
--============================================================
	...
	join djml.RUTAS r on r.RUTA_CODIGO = m.ruta_codigo 

	

	PUEDE SER QUE FALTE ALGUNA CONDICION EN EL WHERE PARA FILTRAR TODOS LOS VIAJES, TERMINAR MIGRACION RUTA PARA CONTROLAR DATOS
	*/
