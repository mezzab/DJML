...
--============================================================
	...
	---VER! SUPUESTAMENTE SON LAS MISMAS CIUDADES EN RUTA_CIUDAD_DESTINO  Y RUTA_CIUDAD_ORIGEN 
...
--============================================================
	...
	where (Pasaje_Codigo <> 0 or Paquete_Codigo <> 0) and Cli_Dir is not null	
	order by Cli_dir
